...
const namePrefix = "Aikodesho";
const description = "Anime Half Chibi Athlete Collection";
...
const extraMetadata = {
  external_url: "https://aikodesho.com", // Replace with your website or remove this line if you do not have one.
};
